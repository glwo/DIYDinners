...
class Recipe(db.Model):
  ...
  step_one = db.Column(db.String(500), nullable=False)
  step_two = db.Column(db.String(500), nullable=False)
  step_three = db.Column(db.String(500), nullable=False)
  step_four = db.Column(db.String(500), nullable=False)
